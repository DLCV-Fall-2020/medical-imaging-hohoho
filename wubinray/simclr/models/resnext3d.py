#ref:https://github.com/kenshohara/video-classification-3d-cnn-pytorch/blob/master/models/resnext.py
import torch
...
__all__ = ['HemoResNeXt3d', 'resnext50_3d', 'resnext101_3d', 'resnext101_3d']
...
class HemoResNeXt3dBottleneck(nn.Module):
    expansion = 2

    def __init__(self, inplanes, planes, cardinality, stride=1, downsample=None):
        super(HemoResNeXt3dBottleneck, self).__init__()
...
class HemoResNeXt3d(nn.Module):
    ...
    def __init__(self, block, layers, sample_size, sample_duration, shortcut_type='B', cardinality=32, num_classes=400, last_fc=True):
        ...
        self.inplanes = 64
        super(HemoResNeXt3d, self).__init__()
...
def resnext50_3d(**kwargs):
    ...
    """
    model = HemoResNeXt3d(HemoResNeXt3dBottleneck, [3, 4, 6, 3], **kwargs)
    return model

def resnext101_3d(**kwargs):
    """Constructs a ResNet-101 model.
    """
    model = HemoResNeXt3d(HemoResNeXt3dBottleneck, [3, 4, 23, 3], **kwargs)
    return model

def resnext152_3d(**kwargs):
    """Constructs a ResNet-101 model.
    """
    model = HemoResNeXt3d(HemoResNeXt3dBottleneck, [3, 8, 36, 3], **kwargs)
    return model
