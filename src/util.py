...
def prediction_to_csv(pt_name_list, image_name_list, prediction, output_csv_name=None,threshold=0.5, to_kaggle=False, remove_defunct=True, magic=True):
    ...
    if magic:
        prediction_df = pattern2pattern(prediction_df, "101", "111")
        prediction_df = pattern2pattern(prediction_df, "010", "000")
